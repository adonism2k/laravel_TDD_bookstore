...
class BooksListTest extends TestCase
{
    ...
    {
        $book1 = factory(Book::class)->create(['title' => 'PHP for begginers', 'published_year' => 2010]);
        $book2 = factory(Book::class)->create(['title' => 'Javascript for dummies', 'published_year' => 2008]);
        $book3 = factory(Book::class)->create(['title' => 'Advanced Python', 'published_year' => 2009]);
